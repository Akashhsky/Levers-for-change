  ...
  function casePhoto(c){
    var text=[c.label,c.sector,c.type].join(' ').toLowerCase();
    var matches=[[/dairy/,'21-dairy'],[/cement/,'24-cement'],[/pharma|\bapi\b/,'15-pharma'],[/textile|fabric|apparel|yarn|knit/,'14-textiles'],[/foundry|casting/,'12-foundry'],[/cable|wire/,'19-cables'],[/copper|non.ferrous|\blead\b/,'18-metals'],[/ceramic|abrasive|refractor/,'22-ceramics'],[/electrical|switchgear|terminal/,'23-electrical'],[/pvc|hdpe|polymer|plastic|soap/,'17-polymers'],[/ductile|di pipes|pipe/,'11-pipes'],[/food|biscuit|fmcg|spice|snack/,'13-food'],[/agri|soya|flour|grain/,'26-agriculture'],[/auto|tyre/,'16-automotive'],[/export/,'28-export'],[/logistic|warehouse|dispatch/,'25-logistics'],[/engineering|machin|pump|tools/,'20-engineering'],[/steel|ferro|furnace/,'10-steel']];
    for(var i=0;i<matches.length;i++)if(matches[i][0].test(text))return 'v3/'+matches[i][1];
    return 'v3/'+({Sales:'04-commercial',Workforce:'05-people',Digitisation:'06-connected',Manufacturing:'03-operations'}[c.domain]||'03-operations');
  }
